  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#0F172A] font-sans antialiased selection:bg-[#EFF6FF] selection:text-[#2563EB]">
      ...
      <div className="bg-[#EFF6FF] border-b border-[#E2E8F0] px-4 py-2 text-center text-xs font-medium text-[#1D4ED8] flex items-center justify-center gap-2">
        ...
        <span>NeoDrive 2.0 is live: Instant Zero-Knowledge Share links</span>
        <a
          href="#features"
          className="underline font-semibold hover:text-[#1E40AF] inline-flex items-center gap-0.5"
        >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-[#0F172A] leading-[1.15]">
              Cloud storage with{" "}
              <span className="text-[#2563EB]">zero friction</span> and
              micro-precision control.
            </h1>

            <p className="mt-6 text-base sm:text-lg text-[#475569] leading-relaxed max-w-2xl mx-auto">
              Effortless folder hierarchies, lightning multi-part uploads,
              granular viewer/editor permissions, and password-protected expiry
              links.
            </p>
            ...
            <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto border-t border-[#E2E8F0] pt-8 text-left">
              <div className="px-3">
                ...
                <p className="text-xs font-medium text-[#64748B] uppercase tracking-wider mt-0.5">
                  SLA Durability
                </p>
              </div>
              <div className="px-3">
              ...
              <div className="bg-[#F8FAFC] border-b border-[#E2E8F0] px-4 py-3 flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-1.5 text-xs text-[#475569]">
                    <span className="font-medium hover:text-[#2563EB] cursor-pointer">
                      My Drive
                    </span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 min-h-[460px]">
                ...
                <aside className="md:col-span-3 border-r border-[#E2E8F0] p-4 bg-[#F8FAFC]/60 flex flex-col justify-between">
                  <div className="space-y-4">
                    <div>
                      <p className="text-[11px] font-bold uppercase tracking-wider text-[#94A3B8] px-2 mb-2">
                        Navigation
                      </p>
                      <div className="space-y-1">
                        ...
                        >
                          ...
                          <span className="text-[10px] bg-[#E2E8F0] text-[#475569] px-1.5 py-0.5 rounded-full font-bold">
                            142
                          </span>
                        </button>
                        ...
                        >
                          ...
                          <span className="text-[10px] bg-[#ECFDF5] text-[#047857] px-1.5 py-0.5 rounded-full font-bold">
                            18
                          </span>
                        </button>
                ...
                <main className="md:col-span-6 p-4">
                          ...
                          >
                            <td className="py-2.5 pl-2">
                              <div className="flex items-center gap-2.5">
                                ...
                                {file.type === "audio" && (
                                  <Music className="w-4 h-4 text-[#F59E0B] shrink-0" />
                                )}
                                <div className="truncate">
                                  <p className="font-semibold text-[#0F172A] truncate max-w-[140px] sm:max-w-[200px]">
                                    {file.name}
                                  </p>
                            ...
                            <td className="py-2.5 hidden md:table-cell text-[#64748B] font-mono text-[11px]">
                              {file.size}
                            </td>
                            <td className="py-2.5 text-right pr-2">
                              <div className="flex items-center justify-end gap-1 text-[#64748B]">
                                ...
                                <button
                                  className="p-1 rounded hover:bg-white hover:text-[#0F172A] transition-colors"
                                  title="Download"
                                >
                  ...
                  <div className="mt-4 border-2 border-dashed border-[#CBD5E1] rounded-lg p-5 text-center bg-[#F8FAFC] hover:bg-[#F1F5F9] transition-colors cursor-pointer">
                    ...
                    <p className="text-xs font-semibold text-[#0F172A]">
                      Drag & drop raw files or folders here
                    </p>
                    <p className="text-[11px] text-[#64748B]">
                      Supports multi-GB 4K videos, zip files, and lossless
                      masters
                    </p>
                  </div>
                </main>
                ...
                <aside className="md:col-span-3 border-t md:border-t-0 md:border-l border-[#E2E8F0] p-4 bg-white">
                  {selectedFile ? (
                    <div className="space-y-4">
                      ...
                      <div>
                        <h4 className="text-xs font-bold text-[#0F172A] break-all">
                          {selectedFile.name}
                        </h4>
                        <p className="text-[11px] text-[#64748B] mt-0.5">
                          {selectedFile.size} • Last touched{" "}
                    ...
                    <div className="h-full flex flex-col items-center justify-center text-center text-[#94A3B8] p-4">
                      ...
                      <p className="text-[11px]">
                        Click any file to inspect metadata, sharing links, and
                        preview
                      </p>
                    </div>
                  )}
            ...
            <div className="px-5 py-4 border-b border-[#E2E8F0] flex items-center justify-between">
              <div>
                <h3 className="text-sm font-bold text-[#0F172A] flex items-center gap-2">
                  ...
                  <span>
                    Share "{selectedFile ? selectedFile.name : selectedFolder}"
                  </span>
                </h3>
                <p className="text-xs text-[#64748B] mt-0.5">
                  Control granular team permissions and secure public URLs
                </p>
              </div>
              <button
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-[#64748B]">
                        Auto-revokes after 7 days • View-only by default
                      </p>
                    </div>
                  </div>
                  <span className="bg-[#ECFDF5] text-[#047857] text-[10px] font-bold px-2 py-0.5 rounded-full">
                    Active
                  </span>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-sm text-[#475569] mt-3">
              Streamlined file mechanics built on proven relational structures
              and low-latency storage primitives.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] hover:border-[#CBD5E1] transition-all shadow-level-1">
              ...
              <p className="text-xs text-[#475569] leading-relaxed">
                Organize deeply nested file trees with instantaneous folder
                moves, bulk renames, tag taxonomies, and fluid path navigation.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] hover:border-[#CBD5E1] transition-all shadow-level-1">
              ...
              <p className="text-xs text-[#475569] leading-relaxed">
                Strict Owner, Editor, and Viewer privileges enforced directly
                via PostgreSQL Row Level Security (RLS) and cryptographic
                tokens.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] hover:border-[#CBD5E1] transition-all shadow-level-1">
              ...
              <h3 className="text-base font-bold text-[#0F172A] mb-2">
                Chunked Uploads & Resumes
              </h3>
              <p className="text-xs text-[#475569] leading-relaxed">
                Direct-to-S3 signed URLs with automated resumable multi-part
                upload pipelines for massive raw video and graphic formats.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] hover:border-[#CBD5E1] transition-all shadow-level-1">
              ...
              <h3 className="text-base font-bold text-[#0F172A] mb-2">
                Expiring Public Links & Passwords
              </h3>
              <p className="text-xs text-[#475569] leading-relaxed">
                Deliver client deliverables safely. Set temporary 24h/7d expiry
                windows, optional PIN protections, and enforce view-only access.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] hover:border-[#CBD5E1] transition-all shadow-level-1">
              ...
              <p className="text-xs text-[#475569] leading-relaxed">
                Accidentally wiped an entire folder? Restores are one click away
                with automated background queues handling safe 30-day retention.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl border border-[#E2E8F0] bg-[#F8FAFC] hover:border-[#CBD5E1] transition-all shadow-level-1">
              ...
              <h3 className="text-base font-bold text-[#0F172A] mb-2">
                Sub-millisecond Search & Filter
              </h3>
              <p className="text-xs text-[#475569] leading-relaxed">
                Filter instantly across gigabytes of assets by MIME type, owner,
                modification timestamp, tags, and favorited states.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="text-xs text-[#475569] mt-2">
              Start free forever with 15 GB. Scale up smoothly as your team’s
              high-res media library expands.
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto bg-[#F8FAFC] rounded-xl border border-[#CBD5E1] p-6 sm:p-8 shadow-level-1">
            ...
            <div className="mt-8 pt-6 border-t border-[#E2E8F0] flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-2 text-xs text-[#475569]">
                ...
                <span>
                  Unlimited sharing links, viewer roles, and zero-loss downloads
                </span>
              </div>
      ...
      <section className="py-16 bg-[#0F172A] text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center space-y-6">
          ...
          <p className="text-sm text-[#94A3B8] max-w-xl mx-auto">
            ...
            Experience clean folder hierarchies and frictionless access control.
          </p>
      ...
      <footer className="bg-white border-t border-[#E2E8F0] py-12 text-xs text-[#64748B]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-2 md:grid-cols-5 gap-8">
          <div className="col-span-2 space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-sm text-[#0F172A]">NeoDrive</span>
            </div>
            <p className="max-w-xs text-[11px] leading-relaxed">
              Precision minimal cloud storage service. High data density, S3
              reliability, and frictionless team collaboration.
            </p>
          ...
          <div>
            <p className="font-bold text-[#0F172A] uppercase tracking-wider text-[11px] mb-3">
              Product
            </p>
            <ul className="space-y-2">
              <li>
                <a href="#features" className="hover:text-[#0F172A]">
                  Folder Tree
                </a>
              </li>
              <li>
                <a href="#demo" className="hover:text-[#0F172A]">
                  Live Sandbox
                </a>
              </li>
              <li>
                <a href="#security" className="hover:text-[#0F172A]">
                  Access Roles
                </a>
              </li>
              <li>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 pt-6 border-t border-[#F1F5F9] flex flex-col sm:flex-row items-center justify-between text-[11px] gap-2">
          <p>© {new Date().getFullYear()} NeoDrive. All rights reserved.</p>
