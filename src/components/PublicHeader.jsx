  ...
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={() => navigate('/login')} className="text-sm cursor-pointer font-medium text-[#475569] hover:text-[#0F172A] px-3 py-2 rounded-lg hover:bg-[#F1F5F9] transition-colors">
              Sign In
            </button>
            <button onClick={() => navigate('/signup')} className="text-sm cursor-pointer font-semibold text-white bg-[#2563EB] hover:bg-[#1D4ED8] px-4 py-2 rounded-lg shadow-sm transition-all transform active:scale-[0.98] flex items-center gap-1.5">
